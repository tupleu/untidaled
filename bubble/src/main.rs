...
const LEVEL_4: [[i32; LEVEL_WIDTH]; LEVEL_HEIGHT] = [
    ...
    [
        36, 12, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 34,
    ],
    [
        36, 42, 00, 00, 00, 00, 41, 00, 00, 00, 00, 00, 00, 00, 00, 00, 32, 00, 00, 34,
    ],
    [
...
const LEVEL_LIST: [[[i32; LEVEL_WIDTH]; LEVEL_HEIGHT]; 5] =
    [TEST_LEVEL, LEVEL_1, LEVEL_2, LEVEL_3, LEVEL_4];
